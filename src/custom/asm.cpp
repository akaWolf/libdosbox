...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        //noecho(); // do not echo
        //keypad(, TRUE); // provide keypad buttons
...
void m2c::ShadowStack::decreasedeep(){
...
//m2c::_STATE * _state;
void CPU_IRET(bool, uint8_t) {}
void CPU_Exception(uint8_t) {}
void CPU_CLI() {}
void CPU_STI() {}
uint8_t mem_readb(uint64_t)
{
}
uint16_t mem_readw(uint64_t)
{
}
uint32_t mem_readd(uint64_t)
{
}
uint8_t mem_writeb(uint64_t, uint8_t)
{
}
uint16_t mem_writew(uint64_t, uint16_t)
{
}
uint32_t mem_writed(uint64_t, uint32_t)
{
}
